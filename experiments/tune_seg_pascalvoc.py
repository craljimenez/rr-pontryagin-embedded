"""Bayesian HPO for UNet segmentation models on PASCAL VOC 2012.
...
from configs.seg_pascalvoc import AVAILABLE_MODELS, DEVICE, RESULTS_DIR
from run_seg_pascalvoc import build_dataloaders, train_one_model
